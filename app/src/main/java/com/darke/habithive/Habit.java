...
public class Habit {
    ...
    public Habit(String name,String userId ,Date createdAt, String habitType, String frequency, ArrayList<Integer> daysOfWeek, ArrayList<Integer> dayOfMonth, ArrayList<String> reminders) {
        this.name = name;
        this.userId = userId;
